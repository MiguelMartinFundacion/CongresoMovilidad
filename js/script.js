...
function scrollFunction() {
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
    ...
    document.getElementById("logo_principal_mobility").style.height = "40px";
    ...
    document.getElementById("logo_principal_mobility").style.marginTop = "0px";
  } else {
    document.getElementById("logo_principal").style.height = "60px";
    document.getElementById("logo_principal_mobility").style.height = "60px";
    ...
    if (screen.width < 480) {
      if (screen.width < 390) {
        ...
        document.getElementById("logo_principal_mobility").style.marginTop = "15px";
      }else{
        document.getElementById("logo_principal").style.marginTop = "10px";
        document.getElementById("logo_principal_mobility").style.marginTop = "10px";
      }
    }
  }
}